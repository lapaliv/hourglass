...
import {HourglassDiff} from '../dist/hourglass.min';
...
// 337 дней в 11 месяцах + 27 = 364 дня
// SELECT TIMEDIFF("","");

describe('HourglassDiff', () => {
    const data = [
        ...
        {start: [3112, 11, 26, 14, 40, 55], end: [9915, 11, 26, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},

        {start: [3112, 11, 1, 14, 40, 55], end: [9915, 11, 1, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 2, 14, 40, 55], end: [9915, 11, 2, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 3, 14, 40, 55], end: [9915, 11, 3, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 4, 14, 40, 55], end: [9915, 11, 4, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 5, 14, 40, 55], end: [9915, 11, 5, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 6, 14, 40, 55], end: [9915, 11, 6, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 7, 14, 40, 55], end: [9915, 11, 7, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 8, 14, 40, 55], end: [9915, 11, 8, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 9, 14, 40, 55], end: [9915, 11, 9, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 10, 14, 40, 55], end: [9915, 11, 10, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 11, 14, 40, 55], end: [9915, 11, 11, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 12, 14, 40, 55], end: [9915, 11, 12, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 13, 14, 40, 55], end: [9915, 11, 13, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 14, 14, 40, 55], end: [9915, 11, 14, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 15, 14, 40, 55], end: [9915, 11, 15, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 16, 14, 40, 55], end: [9915, 11, 16, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 17, 14, 40, 55], end: [9915, 11, 17, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 18, 14, 40, 55], end: [9915, 11, 18, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 19, 14, 40, 55], end: [9915, 11, 19, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 20, 14, 40, 55], end: [9915, 11, 20, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 21, 14, 40, 55], end: [9915, 11, 21, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 22, 14, 40, 55], end: [9915, 11, 22, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 23, 14, 40, 55], end: [9915, 11, 23, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 24, 14, 40, 55], end: [9915, 11, 24, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 25, 14, 40, 55], end: [9915, 11, 25, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 26, 14, 40, 55], end: [9915, 11, 26, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 27, 14, 40, 55], end: [9915, 11, 27, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 28, 14, 40, 55], end: [9915, 11, 28, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 29, 14, 40, 55], end: [9915, 11, 29, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 11, 30, 14, 40, 55], end: [9915, 11, 30, 14, 40, 38], diff: [6802, 11, 30, 23, 59, 43]},
        {start: [3112, 12, 1, 14, 40, 55], end: [9915, 12, 1, 14, 40, 38], diff: [6802, 11, 29, 23, 59, 43]},
    ...
    for (const datum of data) {
        ...
        it(`${start.toDateTimeString()} vs ${end.toDateTimeString()}`, () => {
            const diff = new HourglassDiff(start, end);

            //console.log(diff);
            expect(datum.diff[0]).toBe(diff.years);
            expect(datum.diff[1]).toBe(diff.months);
            expect(datum.diff[2]).toBe(diff.days);
            expect(datum.diff[3]).toBe(diff.hours);
            expect(datum.diff[4]).toBe(diff.minutes);
            expect(datum.diff[5]).toBe(diff.seconds);
        });
    }
});
